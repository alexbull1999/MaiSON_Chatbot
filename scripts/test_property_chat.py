...
# Test user ID (this would normally be a Firebase user ID)
...
# Send messages for each property ID
for property_id in PROPERTY_IDS:
    print(f"\nSending message for property: {property_id}")
    response = send_property_chat(
        message=f"I'm interested in this property {property_id}. Can you tell me more about it?",
