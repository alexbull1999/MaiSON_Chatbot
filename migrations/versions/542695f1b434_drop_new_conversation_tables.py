...
def upgrade() -> None:
    ...
    op.drop_constraint(None, "external_references", type_="foreignkey")
    op.drop_index(
        "ix_external_references_property_conversation_id",
        table_name="external_references",
    )
    op.drop_index(
        "ix_external_references_general_conversation_id",
        table_name="external_references",
    )
    ...
    op.drop_index(
        "ix_property_messages_conversation_id", table_name="property_messages"
    )
    ...
    op.drop_index(
        "ix_property_conversations_user_id", table_name="property_conversations"
    )
    op.drop_index(
        "ix_property_conversations_session_id", table_name="property_conversations"
    )
    op.drop_index(
        "ix_property_conversations_seller_id", table_name="property_conversations"
    )
    op.drop_index(
        "ix_property_conversations_property_id", table_name="property_conversations"
    )
    ...
    op.drop_index(
        "ix_general_conversations_user_id", table_name="general_conversations"
    )
    op.drop_index(
        "ix_general_conversations_session_id", table_name="general_conversations"
    )
