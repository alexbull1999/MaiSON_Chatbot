...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_property_messages_timestamp'), table_name='property_messages')
    op.drop_index(op.f('ix_property_messages_id'), table_name='property_messages')
    op.drop_index(op.f('ix_property_messages_conversation_id'), table_name='property_messages')
    ...
    op.drop_index(op.f('ix_general_messages_conversation_id'), table_name='general_messages')
    op.drop_table('general_messages')
    
    # Drop property_conversations table and its indexes
    op.drop_index(op.f('ix_property_conversations_user_id'), table_name='property_conversations')
    op.drop_index(op.f('ix_property_conversations_session_id'), table_name='property_conversations')
    op.drop_index(op.f('ix_property_conversations_seller_id'), table_name='property_conversations')
    op.drop_index(op.f('ix_property_conversations_property_id'), table_name='property_conversations')
    op.drop_index(op.f('ix_property_conversations_id'), table_name='property_conversations')
    op.drop_table('property_conversations')
    
    # Drop general_conversations table and its indexes
    op.drop_index(op.f('ix_general_conversations_user_id'), table_name='general_conversations')
    op.drop_index(op.f('ix_general_conversations_session_id'), table_name='general_conversations')
    op.drop_index(op.f('ix_general_conversations_id'), table_name='general_conversations')
