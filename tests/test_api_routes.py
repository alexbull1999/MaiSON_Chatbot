...
def test_general_chat_endpoint_missing_session_id(override_get_db, mock_chat_controller):
...
def test_general_chat_endpoint_error_handling(override_get_db, mock_chat_controller):
    ...
    mock_chat_controller.handle_general_chat.side_effect = Exception("Internal server error")
...
def test_property_chat_endpoint_error_handling(override_get_db, mock_chat_controller):
    ...
    # Mock the chat controller to raise an exception
    mock_chat_controller.handle_property_chat.side_effect = Exception("Internal server error")
